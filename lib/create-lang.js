...
async function createLanguageFile(langCode, translationsPath = 'src/assets/i18n', baseLang = 'en') {
	...
	try {
		...
		const translatedData = await translateNestedObject(baseData, langCode);
